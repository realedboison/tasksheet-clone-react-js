          ...
          <div className="px-5 lg:px-10 xl:px-10">
            <div className="mb-10 text-center">
              ...
              <p className="mt-5 text-lg text-lighterGray">
                Create an account and start managing your tasks the easy way
              </p>
            </div>
            <Formik
                        ...
                        <div className="mx-auto mb-2 w-full lg:w-11/12 xl:w-11/12">
                          <div className="relative">
                            ...
                            <Field
                              ...
                              id="password"
                              name="password"
                              className="mt-1 mb-1.5 h-10 w-full rounded-xl border py-6 px-5 pr-16 pl-12 text-lg text-lighterGray focus:outline-none"
